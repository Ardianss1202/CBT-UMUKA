            ...
            <form action="{{ route('soal.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        @if (!empty($soal->file))
                            <img src="{{ asset('upload/gambar_soal/' . $soal->file) }}" class="img-thumbnail mt-2" width="100%">
                        @endif
                    </div>
                    <div class="col-md-9">
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('soal.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a>
